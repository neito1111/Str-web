...
public class DeveloperRunner {
    ...
    public static void main(String[] args) {
         ...
         */
        developerRunner.addDeveloper("Vlad", "Dev", "JS Developer", 2);
        developerRunner.addDeveloper("Vlid", "Dev", "C++ Developer", 2);
        developerRunner.addDeveloper("Vled", "UX", "UX Developer", 4);
